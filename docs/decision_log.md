...
- **Fecha**: 2026-09-02
- **Contexto**: Cuatro compañeros grabados con el autor en la sala. Él los ordenó de oído —hablante A primera, hablante D último, B y C indistinguibles en el medio— y **el informe les dio el mismo nivel a los cuatro**: 15%, 15%, 16% y 21% de vocabulario sobre A2, todos dentro de una banda. Peor: **la que él puso primera salió última**.
